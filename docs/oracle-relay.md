...
```text
Internet
  -> balloon-crumbs.pages.dev (product home, planner and bounded same-origin proxy)
...
- Product home: `https://balloon-crumbs.pages.dev/`.
- Public planner: `https://balloon-crumbs.pages.dev/planner.html`.
