...
`balloon-crumbs-cleanup` invocation.
...
`Authorization: Bearer <BALLOON_CRUMBS_DISCOVERY_ADMIN_TOKEN>`. Leave that setting
...
server-side in `BALLOON_CRUMBS_TOMTOM_TRAFFIC_API_KEY`.
