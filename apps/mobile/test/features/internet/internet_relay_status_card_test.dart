...
import 'package:balloon_crumbs/controllers/internet_relay_controller.dart';
...
import 'package:balloon_crumbs/features/internet/internet_relay_status_card.dart';
...
void main() {
  testWidgets('makes unconfigured state explicit without implying live sync', (
    ...
    expect(
      find.text('Set BALLOON_CRUMBS_API_BASE_URL · no server traffic'),
      findsOneWidget,
    );
