...
class CarPlayTecStatus {
  ...
  /// Nobody is Hot Pursuit, and no surface should imply otherwise.
  ...
  String get _displayName => name ?? 'Hot Pursuit';
...
/// An unanswered leader request for the Hot Pursuit role, addressed to
...
class CarPlayTecRequest {
  ...
  String get title => 'Be Hot Pursuit?';
