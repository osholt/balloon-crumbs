...
/// Where one leader-issued Hot Pursuit request has got to.
///
...
/// One leader-issued request for the Hot Pursuit role.
class TecRoleAssignment {
  ...
  String get statusLabel => switch (status) {
    ...
    TecRoleAssignmentStatus.accepted =>
      '$targetDisplayName accepted Hot Pursuit',
...
/// Every leader-issued Hot Pursuit request in this ride, reconciled.
class TecRoleAssignmentState {
  ...
  /// The rider the leader's own record says is Hot Pursuit.
  ///
