...
/// Whether a ride has a Hot Pursuit, and how usable that TEC's position
...
enum TecAvailability {
  /// No rider holds the Hot Pursuit role. Every distance-to-TEC surface
...
/// Who the Hot Pursuit is, how usable their position is, and their last
/// known fix.
///
...
class LeaderRideStatus {
  ...
  /// Whether any rider is Hot Pursuit. False means the ride has no
...
class LeaderRideStatusCalculator {
  ...
  /// Resolves the Hot Pursuit once, by the rules every TEC surface and
